        ...
        <div class="row">
            <div class="col-md-6">
                <div class="well-block">
                    ...
                    <form name="appointment"  action="/Update_appointments1/{{$appointment[0]->id}}"method="POST">
                        @csrf
                        <div class="row">
                        @foreach ($appointment as $appointment)
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="name" name="name" type="text" class="form-control input-md" value="{{$appointment->name}}" required="Required"onkeyup="validate(this)">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="email" name="email" type="text" class="form-control input-md" value="{{$appointment->email}}"required="Required" onkeyup="validate(this)">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="mobile" name="mobile" type="text" class="form-control input-md" value="{{$appointment->mobile}}"required="Required"onkeyup="validate(this)">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="date" name="date" type="date"  value="{{$appointment->date}}" class="form-control input-md" required="Required">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="time" name="time" value="{{$appointment->time}}" class="form-control" required="Required">
                            ...
                            <div class="col-md-6">
                            	<div class="form-group">
                                    ...
                                    <select id="class" name="price" value="{{$appointment->price}}" class="form-control" required="Required">
                                        <option selected="" value="price">( Please select Pricing )</option>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select id="appointmentfor" name="appointmentfor" class="form-control" value="{{$appointment->appfor}}" required="Required">
