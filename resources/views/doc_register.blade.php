    ...
    <div class="container register bg-danger">
        <div class="row">
            ...
            <div class="col-md-9 register-right">
                ...
                <form name="register doctor" method="POST">
                    @csrf                   
                  <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        <h3  class="register-heading">Enter New Doctors Credentials</h3>
                        <div class="row register-form">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input id="name" type="text" name="name" class="form-control input-md" placeholder=" Name *" value="" onkeyup="validate(this)" />
                                ...
                                <div class="form-group">
                                    <input id="degree" name="degree" type="text" class="form-control input-md" placeholder="Enter your Degree" value="" onkeyup="validate(this)"/>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <select id="specilization" name="specilization" class="form-control" required="required">
